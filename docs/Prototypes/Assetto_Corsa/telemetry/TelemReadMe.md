...
## Contents:
 - __MoTecRaw__: Contains raw .ld files from motec, these can't be worked with directly and have to be converted manually to csvs using motec software -this is now empty as is completely redundant with MotecCSVs
